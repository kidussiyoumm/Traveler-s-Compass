...
namespace Traveler_Compass.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        //(CompassDbContext dbContext) //DI using the compassDbContext class in the controller, 
        //so that we get an instance of the dbcontext class
        ...
        [HttpGet]
        [Route("api/User/{email}/GetUserByEmailAsync")]
        public async Task<IActionResult> GetUserByEmailAsync(string email)
        {
            try
            {
                ...
                var fetchEmail = await _userRepository.GetUserByEmailAsync(email);
                var response = _mapper.Map<UserDTO>(fetchEmail);
                return Ok(response);
            }catch(Exception ex)
            {
